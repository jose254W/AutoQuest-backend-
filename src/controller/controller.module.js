...
var RentalController = /** @class */ (function () {
    ...
    RentalController.prototype.create = function (formData) {
        return __awaiter(this, void 0, void 0, function () {
            var transporter, formDataList, _i, _a, _b, key, value, mailOptions, info, error_1;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        for (_i = 0, _a = Object.entries(formData); _i < _a.length; _i++) {
                            ...
                            formDataList += "".concat(key, ": ").concat(value, "\n");
                        }
                        mailOptions = {
                    ...
                    case 2:
                        info = _c.sent();
                        console.log("Message sent: ".concat(info.messageId));
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _c.sent();
                        console.error("Error sending message: ".concat(error_1));
                        return [3 /*break*/, 4];
    ...
    ], RentalController.prototype, "create");
